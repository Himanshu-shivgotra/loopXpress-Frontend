...
const StartSellingSection = () => {
    return (
        <div className=" container mx-auto py-6 lg:py-16 px-2">
            <div className="flex flex-wrap lg:flex-nowrap gap-4">
            <div className="text-start mt-20 px-0 lg:px-8">
                <div className="mt-0 md:mt-16 lg:mt-30">
            ...
            {/* Right Content (Image) */}
            <div className="mt-20 md:w-full flex justify-center">
                <img
                    src="https://loopin.netlify.app/static/media/seller.950fb2364d15df947190d05adb0f73fb.svg"
                    alt="Start Selling"
